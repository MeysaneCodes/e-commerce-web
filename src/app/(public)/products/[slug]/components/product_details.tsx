...
export default function Product_Details ({inFetched_item,setVariant, Icons }:Props){
    ...
    return (
        <div className="p-4">
            <Card className="h-auto p-5 border-none shadow-none bg-surface">
                <CardBody>
                    <div>
                        ...
                        {/*Product Price*/}
                        <div>
                            <p className={`text-4xl font-bold  flex justify-end ${(inFetched_item?.options?.colors[IMAGE_INDEX].variants[StorageSelected_INDEX].discount ? "text-[#CC291F]" : "text-black")}`}>
                                {
                        ...
                        {/*Financing section*/}
                        <div className="bg-gray-100  flex flex-col mt-5 p-1 rounded-xl gap-2">
                        ...
                        <div className="mt-3 flex items-center gap-1">
                            ...
                            <Typography className="font-bold">myTemplate-Punkte</Typography>
                        ...
                        {/*new Product*/}
                        <div className="">
                            <div className={`w-full h-auto border rounded-xl ${isNewProductClicked ? "border-black border-2" : "border-gray-300" } mb-2 `}>
                            ...
                            <div className={`w-full h-auto border rounded-xl ${!isNewProductClicked  ? "border-black border-2" : "border-green-200" } mb-2 `}>
