    ...
    return (
        <div>
            <Card
                ...
                className="w-[300px] h-[600px] m-3 p-5 bg-white hover:cursor-pointer hover:opacity-80">
                <CardBody className="p-0 m-0 ">
                    ...
                    <div className="mt-2  w-full h-[250px]">
                        {/*Product Image*/}
                        <img className="w-full h-full object-cover" src={"/images/Smartwatch.png"} alt={"Smartwatch"}/>
                    </div>
