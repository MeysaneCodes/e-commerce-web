...
export default function Product_Overview ({data,Images, Icons}:{data:Item_Structure | null |undefined, Images:ColorOption, Icons:any})  {
    ...
    return (
        ...
        <div className="p-4 w-full overflow-y-scroll scrollbar-hide">
            <Card className="p-5 border-none bg-surface">
                <CardBody>
                    ...
                    <div className="flex items-center gap-2   text-gray-600 text-xs">
                        ...
                        <div className="rating">
                            ...
                            <div className="mask mask-star" aria-label="4 star"  aria-current="true" />
                    ...
                    <div className="mt-2 flex overflow-scroll scrollbar-hide">
                        <p className="border border-gray-600 whitespace-nowrap text-gray-600  mr-2 text-xs p-1 inline-flex">Versandkostenfrei</p>
                        <p className="border border-gray-600 whitespace-nowrap text-gray-600  mr-2 text-xs p-1 inline-flex">myTemplate-Rabatt verfügbar</p>
                    </div>
